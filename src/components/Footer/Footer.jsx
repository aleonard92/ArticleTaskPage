      ...
      <div className="container mx-auto px-2 md:px-12 flex flex-col md:flex-row justify-between">
        ...
        <div id='download' className="mx-4 lg:min-w-[200px] pt-20">
          <div>
            ...
            <a data-aos="fade-up" data-aos-duration="1500" href="/folder/ResumenWhitePaperesp.pdf" target="_blanck" className="text-blue-700 font-bold underline underline-offset-4"> {t('footer.download')} </a>
          </div>
          <div className='mt-2'>
            <a data-aos="fade-up" data-aos-duration="1500" href="/folder/WhitePaperLehtVesionesp.pdf" target="_blanck" className="text-blue-700 font-bold underline underline-offset-4"> {t('footer.download2')} </a>
          </div>
        </div>
        <div className="mx-4  pt-20">
          <LangSelector/>
